...
@include('layouts.sidebar')
    <div class="main-content-area">
        <div class="page-title-section">
            <h2><span class="gradient-text">Upload</span> Service</h2>
        </div>
        <!--  upload item form -->
        <form class="cryptoki-form" action="{{route('products.store')}}" method="post" enctype="multipart/form-data"
            id="upload-item-form">
            @csrf
            <div class="upload-row">
                <div class="upload-column">
                    ...
                    <div class="form-field">
                        <label for="item-tags">Price</label>
                    ...
                    <div class="upload-container">
                        <div class="artwork-upload">
                            ...
                            <div class="upload-box"><svg class="crumina-icon">
                                ...
                                <input type="file" name="cover_img" class="">
                                <!-- <button
