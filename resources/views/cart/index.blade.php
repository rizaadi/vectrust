                ...
                <div class="megamenu">
                    <div class="megamenu-wrapper">
                        <div class="megamenu-column">
                            ...
                            <div>
                                <ul class="submenu-column">
                                    ...
                                    <li class="menu-item"><a href="06-profile-page.html" class="menu-link">Profile
                                            Page</a>
                                    </li>
                                </ul>
                                <ul class="submenu-column">
                                    <li class="menu-item"><a href="07-sellers.html" class="menu-link">Sellers</a></li>
                                    <li class="menu-item"><a href="08-shopping-cart.html" class="menu-link">Shopping
                                            Cart</a>
                                    </li>
                                    <li class="menu-item"><a href="09-checkout.html" class="menu-link">Checkout</a></li>
                        ...
                        <div class="megamenu-column">
                            ...
                            <div>
                                <ul class="submenu-column">
                                    <li class="menu-item"><a href="26-profile-info.html" class="menu-link">Profile
                                            Info</a>
                                    </li>
                                    ...
                                    <li class="menu-item"><a href="12-profile-upload-item.html" class="menu-link">Upload
                                            Item</a></li>
                                </ul>
                                <ul class="submenu-column">
            ...
            <table class="content-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('cart.destroy', $item['id']) }}"><button class="close"><svg
                                        class="crumina-icon">
                ...
                <div class="cart-total-box">
                    <div class="cart-total-wrapper">
                        ...
                        <div class="to-checkout-button">
                            <button id="button-start-demo" class="btn btn-fullwidth gradient-background" type="submit">
